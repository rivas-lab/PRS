...
if [ "${refit}" == "T" ] ; then
    ...
    zstdcat ${phe_file} | awk -v OFS='\t' -v pop="others" '((NR>1) && ($4 == pop) && ($5 == "train" || $5  == "val")){print $1, $2}' > ${keep}
else
    results_sub_dir="1_fit_w_val"
    keep="/scratch/groups/mrivas/ukbb24983/sqc/population_stratification_w24983_20211020/ukb24983_others.phe"
fi
