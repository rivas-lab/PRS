...
phe_file="/scratch/groups/mrivas/projects/PRS/private_output/20211022_400k/20211022.phe.zst"
...
if [ "${refit}" == "T" ] ; then
    ...
    zstdcat ${phe_file} | awk -v OFS='\t' '((NR>1) && ($NF == "train" || $NF  == "val")){print $1, $2}' > ${keep}
else
    results_sub_dir="1_fit_w_val"
    keep="/scratch/groups/mrivas/projects/PRS/private_output/20211022_400k/20211022.keep.phe"
fi
...
$([ "${refit}" == "T" ] && echo "--split_col NULL" || echo "--split_col split_400k") \
${genotype_pfile} \
${phe_file} \
${phenotype_name} \
${family} \
