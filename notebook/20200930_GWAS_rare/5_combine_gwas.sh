...
src=/oak/stanford/groups/mrivas/users/ytanigaw/repos/rivas-lab/ukbb-tools/04_gwas/extras/20200930_gwas_parallel/3_combine_results.sh
...
echo "# ${GBE_ID} ${sub_d}"
bash ${src} --GBE_ID ${GBE_ID} --cores 6 ${out_d}/${sub_d}
