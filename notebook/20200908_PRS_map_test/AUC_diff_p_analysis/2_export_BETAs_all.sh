...
results_dir="/oak/stanford/groups/mrivas/projects/PRS/private_output/20200908_PRS_map_test/${run_name}/${GBE_ID}/1_fit_w_val"

# export BETAs
Rscript export_BETAs.R ${GBE_ID} ${results_dir}
