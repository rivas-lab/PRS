...
keep=${results_dir}/2_refit/keep.phe
...
--refit_from_RData ${results_dir}/1_fit_w_val/snpnet.RData \
--split_col NULL \
${genotype_pfile} \
${phe_file} \
${phenotype_name} \
...
Rscript ${SRCDIR}/snpnet.eval.R ${phenotype_name} ${results_dir}/2_refit refit
