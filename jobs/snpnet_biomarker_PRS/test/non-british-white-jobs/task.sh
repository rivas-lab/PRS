...
script="/oak/stanford/groups/mrivas/users/ytanigaw/repos/rivas-lab/PRS/src/snpnet_multi_ethnic_prediction_adhock.sh"
in_file=$( get_line_from_job_tsv  $job_tsv_file $task_id )

bash $script $in_file "bin" $memory $threads
